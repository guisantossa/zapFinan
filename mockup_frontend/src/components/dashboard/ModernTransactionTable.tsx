        ...
        <CardHeader className="relative border-b border-gray-200/30 dark:border-gray-700/30">
          ...
          >
            ...
            <Button 
              variant="ghost" 
              size="sm" 
              className="rounded-xl text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
            >
              Ver todas
            </Button>
          </motion.div>
            ...
            <TableBody>
              {transactions.map((transaction, index) => (
                ...
                >
                  ...
                  <TableCell className="py-4">
                    <Badge 
                      className={`${statusConfig[transaction.status].className} rounded-xl font-medium px-3 py-1 border`}
                    >
